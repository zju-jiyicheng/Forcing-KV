...
CFG="$ROOT/configs/self_forcing_inference.yaml"
BACKUP="$ROOT/configs/self_forcing_inference.yaml.bak_fps_sweep"
LOG_DIR="$ROOT/experiment_logs/self_forcing_fps_sweep"
...
for combo in "${combos[@]}"; do
  ...
  out_folder="videos/inference/self_forcing_sink_attn/attn${local_attn}_sink${sink_size}"
