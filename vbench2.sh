...
videos_path='/ycji/code/Forcing-KV/videos_new/vbench/realtime_5s_sink0_attn10'
config_path='configs/realtime_vbench.yaml'
result_name="realtime_5s_sink0_attn10"

# Step 1. Generate Videos
torchrun --nproc_per_node=1 --master_port=38596 sample_vbench.py --config_path $config_path
...
for dimension in "${dimensions[@]}"; do
    ...
    MASTER_PORT=38574 python evaluate.py --videos_path $videos_path --dimension $dimension --output_path $output_path
done
