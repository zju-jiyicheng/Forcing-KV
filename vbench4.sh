...
videos_path='/ycji/code/Forcing-KV/videos_new/vbench/forcingkv_self_forcing_{modify}_{naive_sink3_0.8}_5s_ar1_sink1_spatial1_temporal0_dynamic0_patch6_0.33'
config_path='configs/forcingkv_self_forcing_vbench.yaml'
result_name="forcingkv_self_forcing_{modify}_{naive_sink3_0.8}_5s_ar1_sink1_spatial1_temporal0_dynamic0_patch6_0.33"
