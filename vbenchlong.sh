...
videos_path='/ycji/code/Forcing-KV/videos_new/vbench/forcingkv_{1+3.1}_{naive_sink3_0.8}_longlive_30s_ar4_sink1_s1_t1_d1_patch3_0.33'
config_path='configs/forcingkv_longlive_vbenchlong.yaml'
result_name="forcingkv_{1+3.1}_{naive_sink3_0.8}_longlive_30s_ar4_sink1_s1_t1_d1_patch3_0.33"

# Step 1. Generate Videos
torchrun --nproc_per_node=1 --master_port=38511 sample_vbench.py --config_path $config_path
