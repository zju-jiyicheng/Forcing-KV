...
videos_path='/nfs/ycji_temp/code/DummyForcing/videos/vbench/forcingkv_buffer_ar4_sink0_s6_t0'
config_path='configs/forcingkv_longlive_vbenchlong.yaml'
result_name="forcingkv_buffer_ar4_sink0_s6_t0"

# Step 1. Generate Videos
torchrun --nproc_per_node=1 --master_port=38542 sample_vbench.py --config_path $config_path
