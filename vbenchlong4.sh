...
videos_path='/nfs/ycji_temp/code/DummyForcing/videos/vbench/dummy_self_forcing_30s_0.25_ctx1'
config_path='configs/dummy_self_forcing_vbenchlong.yaml'
result_name="dummy_self_forcing_30s_0.25_ctx1"

# Step 1. Generate Videos
torchrun --nproc_per_node=1 --master_port=38545 sample_vbench.py --config_path $config_path
