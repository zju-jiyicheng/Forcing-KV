...
videos_path='/nfs/ycji_temp/code/DummyForcing/videos/vbench/dummy_longlive_30s_ctx1_0.25'
config_path='configs/dummy_longlive_vbenchlong.yaml'
result_name="dummy_longlive_30s_ctx1_0.25"

# Step 1. Generate Videos
torchrun --nproc_per_node=1 --master_port=38540 sample_vbench.py --config_path $config_path
