...
videos_path='/ycji/code/Forcing-KV/videos_new/vbench/forcingkv_realtime_5s_ar1_sink1_static1_temporal3'
config_path='configs/forcingkv_realtime_vbench.yaml'
result_name="forcingkv_realtime_5s_ar1_sink1_static1_temporal3"

# Step 1. Generate Videos
torchrun --nproc_per_node=1 --master_port=38582 sample_vbench.py --config_path $config_path
...
for dimension in "${dimensions[@]}"; do
    ...
    MASTER_PORT=38560 python evaluate.py --videos_path $videos_path --dimension $dimension --output_path $output_path
done
