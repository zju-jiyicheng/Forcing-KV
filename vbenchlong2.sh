...
videos_path='/nfs/ycji_temp/code/DummyForcing/videos/vbench/forcingkv_buffer_neibour_continues_longlive_60s_ar4_sink1_spatial1_temporal1_dynamic1_patch3_sim0.33'
config_path='configs/forcingkv_longlive_vbenchlong.yaml'
result_name="forcingkv_buffer_neibour_continues_longlive_60s_ar4_sink1_spatial1_temporal1_dynamic1_patch3_sim0.33"

# Step 1. Generate Videos
torchrun --nproc_per_node=1 --master_port=38538 sample_vbench.py --config_path $config_path
