...
from pipeline.causal_inference_dummyforcing import CausalInferencePipeline_Dummy_Forcing, _append_fps_record
import torch.distributed as dist
from utils.debug_option import DEBUG


class InteractiveCausalInferencePipeline_Dummy(CausalInferencePipeline_Dummy_Forcing):
    def __init__(
        self,
        args,
        device,
