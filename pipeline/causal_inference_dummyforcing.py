...
class CausalInferencePipeline_Dummy_Forcing(torch.nn.Module):
    def __init__(
            self,
            args,
            device,
        ...
        self.generator = WanDiffusionWrapper(
            **getattr(args, "model_kwargs", {}), is_causal=True, method='dummy_forcing') if generator is None else generator
