...
videos_path='/nfs/ycji_temp/code/DummyForcing/videos/vbench/forcingkv_self_forcing_30s_ar1_sink1_spatial1_temporal3_dynamic1_patch3_sim0.33'
config_path='configs/forcingkv_self_forcing_vbenchlong.yaml'
result_name="forcingkv_self_forcing_30s_ar1_sink1_spatial1_temporal3_dynamic1_patch3_sim0.33"

# Step 1. Generate Videos
torchrun --nproc_per_node=1 --master_port=38544 sample_vbench.py --config_path $config_path
